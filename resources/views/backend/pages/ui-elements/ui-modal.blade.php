                ...
                <div class="row">
                    <div class="col-sm-12 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="mb-1">Below is a <em>static</em> modal example (meaning its
                                    <code>position</code> and <code>display</code> have been overridden). Included are
                                    the modal header, modal body (required for <code>padding</code>), and modal footer
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="mb-1">When modals become too long for the user’s viewport or device, they
                                    scroll independent of the page itself. Try the demo below to see what we mean.</p>
                                <!-- Button trigger modal -->
                                <button type="button" class="btn btn-primary mt-2" data-toggle="modal"
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="mb-1">Modals have three optional sizes, available via modifier classes to be
                                    placed on a .modal-dialog. These sizes kick in at certain breakpoints to avoid
                    ...
                    <div class="col-sm-12 col-lg-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="mb-1">Add <code class="highlighter-rouge">.modal-dialog-centered</code> to
