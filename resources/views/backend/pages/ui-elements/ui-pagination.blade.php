                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p>In addition, as pages likely have more than one such navigation section, it’s
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p>While the <code>.disabled</code> class uses <code>pointer-events: none</code> to
                                    ...
                                    such, you should always add <code>tabindex="-1"</code> on disabled links and use
