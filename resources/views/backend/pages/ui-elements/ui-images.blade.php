                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-lg-6 col-md-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p>In addition to our <a href="/docs/4.3/utilities/borders/">border-radius
                                        utilities</a>, you can use <code>.img-thumbnail</code> to give an image a
                                ...
                                <ul class="list-unstyled p-0 m-0 row">
                                    <li class="col-lg-4 col-md-6 col-sm-6 mt-2"><img src="../assets/images/page-img/10.jpg"
                                            class="img-thumbnail w-100 img-fluid rounded" alt="Responsive image"></li>
                                    <li class="col-lg-4 col-md-6 col-sm-6 mt-2"><img src="../assets/images/page-img/11.jpg"
                                            class="rounded w-100 img-fluid rounded" alt="Responsive image"></li>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p>In addition to our <a href="/docs/4.3/utilities/borders/">border-radius
                                        utilities</a>, you can use <code>.img-thumbnail</code> to give an image a
                                    rounded 1px border appearance.</p>
                                <img src="../assets/images/page-img/13.jpg" class=" mt-2 img-fluid rounded"
                                    alt="Responsive image">
                                <img src="../assets/images/page-img/14.jpg" class=" mt-2 img-fluid rounded float-right"
                                    alt="Responsive image">
                            </div>
                        </div>
                        <div class="card">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li class="media my-4">
                                        <img src="../assets/images/page-img/15.jpg"
                                            class="mr-3 avatar-70 img-fluid rounded" alt="#">
                                        <div class="media-body">
                                            <h5 class="mt-0 mb-1">List-based media object</h5>
                                            Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque
                                    ...
                                    <li class="media">
                                        <img src="../assets/images/page-img/16.jpg"
                                            class="mr-3 avatar-70 img-fluid rounded" alt="#">
                                        <div class="media-body">
                                            <h5 class="mt-0 mb-1">List-based media object</h5>
                                            Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque
