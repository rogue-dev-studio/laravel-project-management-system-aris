                ...
                <div class="row">
                    <div class="col-sm-12 col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p>The most basic list group is an unordered list with list items and the proper
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p>Add <code>.disabled</code> to a <code>.list-group-item</code> to make it
                                    <em>appear</em> disabled. Note that some elements with <code>.disabled</code> will
                                    also require custom JavaScript to fully disable their click events (e.g., links).
                                </p>
                                <ul class="list-group">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p>Add <code class="highlighter-rouge">.list-group-flush</code> to remove some borders
                                    and rounded corners to render list group items edge-to-edge in a parent container
                                    (e.g., cards).</p>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p>Add badges to any list group item to show unread counts, activity, and more with the
                                    help of some <a href="/docs/4.3/utilities/flex/">utilities</a>.</p>
                                <ul class="list-group">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <ul class="list-group">
                                    <li
                                        class="list-group-item d-flex justify-content-between align-items-center iq-bg-primary">
                                        Cras justo odio
                                        <span class="badge badge-primary badge-pill">14</span>
                                    </li>
                                    <li
                                        class="list-group-item d-flex justify-content-between align-items-center iq-bg-success">
                                        Dapibus ac facilisis in
                                        <span class="badge badge-success badge-pill">2</span>
                                    </li>
                                    <li
                                        class="list-group-item d-flex justify-content-between align-items-center iq-bg-danger">
                                        Morbi leo risus
                                        <span class="badge badge-danger badge-pill">1</span>
                                    </li>
                                </ul>
                    ...
                    <div class="col-sm-12 col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p>Add <code>.active</code> to a <code>.list-group-item</code> to indicate the current
                                    active selection.</p>
                                <ul class="list-group">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p>Use <code>&lt;a&gt;</code>s or <code>&lt;button&gt;</code>s to create
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p>Add <code>.list-group-horizontal</code> to change the layout of list group items from
                                    ...
                                    variant <code>.list-group-horizontal-{sm|md|lg|xl}</code> to make a list group
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p>Add nearly any HTML within, even for linked list groups like the one below, with the
                                    help of <a href="/docs/4.3/utilities/flex/">flexbox utilities</a>.</p>
                                <div class="list-group">
                                    <a href="#" class="list-group-item list-group-item-action active">
