                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <div class="header-title">
                                    <h4 class="card-title">Omeans Team Color</h4>
                                </div>
                            </div>
                            <div class="card-body">
                                <p>Similar to the contextual text color classes, easily set the background of an element
                                    to any contextual class. Anchor components will darken on hover, just like the text
                                    classes. Background utilities <strong>do not set <code>color</code></strong>, so in
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mt-4">
                                    <div class="col-lg-2 col-md-6 text-center">
                                        <p class="bg-primary-light pt-5 pb-5 text-center rounded font-size-18">Primary
                                        </p>
                                    </div>
                                    <div class="col-lg-2 col-md-6 text-center">
                                        <p class="bg-secondary-light pt-5 pb-5 text-center rounded font-size-18">
                                            Secondary</p>
                                    </div>
                                    <div class="col-lg-2 col-md-6 text-center">
                                        <p class="bg-success-light pt-5 pb-5 text-center rounded font-size-18">Success
                                        </p>
                                    </div>
                                    <div class="col-lg-2 col-md-6 text-center">
                                    ...
                                    <div class="col-lg-2 col-md-6 text-center">
                                        <p class="bg-warning-light pt-5 pb-5 text-center rounded font-size-18">Warning
                                        </p>
                                    </div>
                                    <div class="col-lg-2 col-md-6 text-center">
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <div class="header-title">
                                    <h4 class="card-title">Omeans Team Text Color</h4>
                                </div>
                            </div>
                            <div class="card-body">
                                <p>Contextual text classes also work well on anchors with the provided hover and focus
                                    states. <strong>Note that the <code>.text-white</code> and <code>.text-muted</code>
                                        class has no additional link styling beyond underline.</strong></p>
                            ...
                            <div class="card-body">
                                <p>Contextual text classes also work well on anchors with the provided hover and focus
                                    states. <strong>Note that the <code>.text-white</code> and <code>.text-muted</code>
                                        class has no additional link styling beyond underline.</strong></p>
                                <p><a href="#"
                                        class="bg-primary-light pl-3 pr-3 pt-2 pb-2 rounded d-inline-block">Primary
                                        link</a></p>
                                <p><a href="#"
                                        class="bg-secondary-light pl-3 pr-3 pt-2 pb-2 rounded d-inline-block">Secondary
                                        link</a></p>
                                <p><a href="#"
                                        class="bg-success-light pl-3 pr-3 pt-2 pb-2 rounded d-inline-block">Success
                                        link</a></p>
                                <p><a href="#"
                                        class="bg-danger-light pl-3 pr-3 pt-2 pb-2 rounded d-inline-block">Danger
                                        link</a></p>
                                <p><a href="#"
                                        class="bg-warning-light pl-3 pr-3 pt-2 pb-2 rounded d-inline-block">Warning
                                        link</a></p>
                                <p><a href="#"
                                        class="bg-info-light pl-3 pr-3 pt-2 pb-2 rounded d-inline-block">bg-Info
                                        link</a></p>
                                <p class="mb-0"><a href="#"
                                        class="dark pl-3 pr-3 pt-2 pb-2 rounded d-inline-block">Dark
                                        link</a></p>
                            </div>
                        </div>
                    </div>
