                    ...
                    <div class="col-sm-6 col-md-6 col-lg-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">It is a long established fact that a reader will be distracted by
                                    the readable content of a page when looking at its layout. </p>
                                <p>It is a long established fact that a the readable content of a page when looking at
                                    its layout.</p>
                        ...
                        <div class="card text-white bg-primary">
                            <div class="card-body">
                                ...
                                <blockquote class="blockquote mb-0">
                                    <p class="font-size-14">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="card border-primary">
                            <div class="card-body text-primary">
                                ...
                                <p class="card-text">Some quick example text to build on the card title text to build on
