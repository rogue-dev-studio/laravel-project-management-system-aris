                                        ...
                                        <div class="col-sm-12">
                                            <div class="col-md-12 p-0">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 form-group">
                                                        <label for="cpwd" class="control-label">Confirm Password:
                                                            *</label>
                                                        <input type="password" class="form-control" id="cpwd"
                                                            required="required" name="cpwd"
                                                            placeholder="Confirm Password">
                                                    </div>
                                                    <div class="col-md-6 form-group">
                                                        <label for="cno" class="control-label">Contact Number:
                                                            *</label>
                                                        <input type="text" class="form-control" required="required"
                                                            id="cno" name="cno" placeholder="Contact Number">
                                                    </div>
                                                    <div class="col-md-6 form-group">
                                                        <label for="acno" class="control-label">Alternate Contact
                                                            Number: *</label>
                                                        <input type="text" class="form-control" required="required"
                                                            id="acno" name="acno"
                                    ...
                                    <div class="row setup-content" id="document-detail">
                                        <div class="col-sm-12">
                                            <div class="col-md-12 p-0">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 form-group">
                                                        <label for="fname" class="control-label">Company Name:
                                                            *</label>
                                                        <input type="text" class="form-control" required="required"
                                                            id="fname" name="fname" placeholder="Company Name">
                                                    </div>
                                                    <div class="col-md-6 form-group">
                                                        <div class="form-group">
                                                            <label for="ccno" class="control-label">Contact Number:
                                                                *</label>
                                                            <input type="text" class="form-control"
                                                                required="required" id="ccno" name="ccno"
                                                    ...
                                                    <div class="col-md-6 form-group">
                                                        <div class="form-group">
                                                            <label for="url" class="control-label">Company Url:
                                                                *</label>
                                                            <input type="text" class="form-control"
                                                                required="required" id="url" name="url"
                                                                placeholder="Company Url.">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 form-group">
                                                        <div class="form-group">
                                                            <label for="cemail" class="control-label">Company Mail Id:
                                                                *</label>
                                                            <input type="email" class="form-control"
                                                                required="required" id="cemail" name="cemail"
                                                                placeholder="Company Mail Id.">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="cadd" class="control-label">Company Address:
                                                                *</label>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="col-md-12 p-0">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 form-group">
                                                        <label for="accname" class="control-label">Account Holder Name:
                                                            *</label>
                                                        <input type="text" class="form-control" required="required"
                                                    ...
                                                    <div class="col-md-6 form-group">
                                                        <label for="branch" class="control-label">Bank Branch Name:
                                                            *</label>
                                                        <input type="text" class="form-control" required="required"
                                            ...
                                            <div class="col-md-12 p-0">
                                                ...
                                                <div class="row justify-content-center">
                                                    <div class="col-3"> <img src="images/page-img/img-success.png"
                                                            class="fit-image" alt="img-success"> </div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
