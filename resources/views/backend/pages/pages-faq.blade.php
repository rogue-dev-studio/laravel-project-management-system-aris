                    ...
                    <div class="col-lg-6">
                        <div class="iq-accordion career-style faq-style">
                            <div class="card iq-accordion-block">
                                ...
                                <div class="accordion-details collapse show" id="collapseOne"
                                    aria-labelledby="headingOne" data-parent="#faqAccordion">
                                    <p class="mb-0">Many desktop publishing packages and web page editors now use Lorem
                            ...
                            <div class="card iq-accordion-block">
                                <div class="active-faq clearfix" id="headingTwo">
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col-sm-12"><a role="contentinfo"
                                                    class="accordion-title collapsed" data-toggle="collapse"
                                                    data-target="#collapseTwo" aria-expanded="false"
                                                    aria-controls="collapseTwo"><span> Distracted by the readable page
                                                        whent? </span> </a></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-details collapse" id="collapseTwo" aria-labelledby="headingTwo"
                                    ...
                                    <p class="mb-0">It has survived not only five centuries, but also the leap into
                                        electronic typesetting. Neque porro quisquam est, qui dolorem ipsum quia dolor
                                    ...
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col-sm-12"><a role="contentinfo"
                                                    ...
                                                    aria-controls="collapseThree"><span>What is user interface kit?
                                                    </span> </a></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-details collapse" id="collapseThree"
                                    ...
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col-sm-12"><a role="contentinfo"
                                                    ...
                                                    aria-controls="collapseFour"><span> The readable content layout?
                                                    </span> </a></div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col-sm-12"><a role="contentinfo"
                                                    ...
                                                    aria-controls="collapseFive"><span> The readable content of a page
                                                        at its layout? </span> </a></div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col-sm-12"><a role="contentinfo"
                                                    ...
                                                    aria-controls="collapseSix"><span> What is user interface kit?
                                                    </span> </a></div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="iq-accordion career-style faq-style">
                            <div class="card iq-accordion-block">
                                <div class="active-faq clearfix" id="headingSeven">
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col-sm-12"><a role="contentinfo" class="accordion-title"
                                                    data-toggle="collapse" data-target="#collapseSeven"
                                                    aria-expanded="true" aria-controls="collapseSeven"><span> It is a
                                                        long established fact reader will be? </span> </a></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-details collapse" id="collapseSeven"
                                    ...
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col-sm-12"><a role="contentinfo"
                                                    ...
                                                    aria-controls="collapseEight"><span> Distracted by readable content
                                                        of a page? </span> </a></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-details collapse" id="collapseEight"
                                    ...
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col-sm-12"><a role="contentinfo"
                                                    ...
                                                    aria-controls="collapseNine"><span> Distracted by
                                    ...
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col-sm-12"><a role="contentinfo"
                                                    ...
                                                    aria-controls="collapseTen"><span> The readable content and
                                                        survived? </span> </a></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-details collapse" id="collapseTen" aria-labelledby="headingTen"
                                    data-parent="#faqAccordion">
                                    <p class="mb-0">It has survived not only five centuries, but also the leap into
                                        electronic typesetting. Neque porro quisquam est, qui dolorem ipsum quia dolor
                                        sit amet, consectetur.</p>
                                    ...
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col-sm-12"><a role="contentinfo"
                                                    ...
                                                    aria-controls="collapseEleven"><span> The readable content of a page
                                                        layout? </span> </a></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-details collapse" id="collapseEleven"
                                    ...
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col-sm-12"><a role="contentinfo"
                                                    ...
                                                    aria-controls="collapseTwelve"><span> What is user interface kit?
                                                    </span> </a></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-details collapse" id="collapseTwelve"
                                    aria-labelledby="headingTwelve" data-parent="#faqAccordion">
                                    <p class="mb-0">It has survived not only five centuries, but also the leap into
                                        electronic typesetting. Neque porro quisquam est, qui dolorem ipsum quia dolor
                                        sit amet, consectetur.</p>
                                </div>
                                ...
                                <div class="active-faq clearfix" id="headingThrteen">
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col-sm-12"><a role="contentinfo"
                                                    class="accordion-title collapsed" data-toggle="collapse"
                                                    data-target="#collapseThrteen" aria-expanded="false"
                                                    aria-controls="collapseThrteen"><span> The content of a page abd
                                                        layout? </span> </a></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-details collapse" id="collapseThrteen"
                                    aria-labelledby="headingThrteen" data-parent="#faqAccordion">
                                    <p class="mb-0">It has survived not only five centuries, but also the leap into
                                        electronic typesetting. Neque porro quisquam est, qui dolorem ipsum quia dolor
                                        sit amet, consectetur.</p>
                                </div>
