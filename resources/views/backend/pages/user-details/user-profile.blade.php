                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-3">
                                    <div class="profile-img position-relative">
                                        <img src="../assets/images/user/1.jpg" class="img-fluid rounded avatar-110"
                                            alt="profile-image">
                                    </div>
                                    <div class="ml-3">
                                        ...
                                        <div class="row">
                                                ...
                                                <ul class="list-inline p-0 m-0">
                                                    <li class="mb-4">
                                                        <div class="d-flex align-items-center pt-2">
                                                            <img src="../assets/images/profile/service/01.png"
                                                    ...
                                                    <li class="mb-4">
                                                        <div class="d-flex align-items-center pt-2">
                                                            <img src="../assets/images/profile/service/02.png"
                                                    ...
                                                    <li>
                                                        <div class="d-flex align-items-center pt-2">
                                                            <img src="../assets/images/profile/service/03.png"
                                                                class="img-fluid" alt="image">
                                                            <div class="ml-3 w-100">
                                                                <div
                                                                    class="media align-items-center justify-content-between">
                                            ...
                                            <div class="col-lg-6">
                                                <ul class="list-inline p-0 m-0">
                                                    <li class="mb-4">
                                                        <div class="d-flex align-items-center pt-2">
                                                            <img src="../assets/images/profile/service/04.png"
                                                                class="img-fluid" alt="image">
                                                            <div class="ml-3 w-100">
                                                                <div
                                                                    class="media align-items-center justify-content-between">
                                                    ...
                                                    <li class="mb-4">
                                                        <div class="d-flex align-items-center pt-2">
                                                            <img src="../assets/images/profile/service/05.png"
                                                                class="img-fluid" alt="image">
                                                            <div class="ml-3 w-100">
                                                                <div
                                                                    class="media align-items-center justify-content-between">
                                                    ...
                                                    <li>
                                                        <div class="d-flex align-items-center pt-2">
                                                            <img src="../assets/images/profile/service/06.png"
                                                                class="img-fluid" alt="image">
                                                            <div class="ml-3 w-100">
                                                                <div
                                                                    class="media align-items-center justify-content-between">
